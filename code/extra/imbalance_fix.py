...
# Load the dataset
input_file = '../data/extra/ground_truth_reviews.csv'  # Path to your original reviews dataset
output_file = '../data/extra/balanced_ground_truth.csv'  # Path to save the new balanced dataset
