...
predictions_file = "../../data/keywords_topics/tweaked/kt_results.csv"  # Updated file path for keywords and topics results
...
try:
    ...
    y_pred = df_pred['overall_sentiment'].astype(str).str.strip().str.capitalize()  # Corrected to 'overall_sentiment'
    ...
    df_metrics.to_csv("../../data/keywords_topics/tweaked/kt_evaluation_metrics.csv", index=False)
    ...
    df_report.to_csv("../../data/keywords_topics/tweaked/kt_classification_report.csv", index=True)
    ...
    df_conf_matrix.to_csv("../../data/keywords_topics/tweaked/kt_confusion_matrix.csv", index=True)
    ...
    if not df_misclassified.empty:
        ...
        df_misclassified.to_csv("../../data/keywords_topics/tweaked/kt_misclassified_reviews.csv", index=False)
