...
# Correct local directory where the model and tokenizer are stored
model_directory = "C:/Users/twoce/.cache/huggingface/hub/models--cardiffnlp--twitter-xlm-roberta-base-sentiment"

# Load the model and tokenizer from the local directory
model = XLMRobertaForSequenceClassification.from_pretrained(model_directory)
tokenizer = XLMRobertaTokenizer.from_pretrained(model_directory)

# Create the sentiment analysis pipeline
sentiment_checker = pipeline("sentiment-analysis", model=model, tokenizer=tokenizer)
...
import pandas as pd
labeled_data = pd.read_csv("../../data/ground_truth/balanced_ground_truth.csv")
