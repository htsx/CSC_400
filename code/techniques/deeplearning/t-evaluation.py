...
predictions_file = "../../data/deeplearning/t-dl_results.csv"
...
try:
    ...
    df_metrics.to_csv("../../data/deeplearning/t-dl_evaluation_metrics.csv", index=False)
    ...
    df_report.to_csv("../../data/deeplearning/t-dl_classification_report.csv", index=True)
    ...
    df_conf_matrix.to_csv("../../data/deeplearning/t-dl_confusion_matrix.csv", index=True)
    ...
    if not df_misclassified.empty:
        df_misclassified.to_csv("../../data/deeplearning/t-dl_misclassified_reviews.csv", index=False)
