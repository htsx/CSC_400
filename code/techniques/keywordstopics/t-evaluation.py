...
predictions_file = "../../data/keywordstopics/t_kt_results.csv"  # Updated file path for keywords and topics results
...
try:
    ...
    df_metrics.to_csv("../../data/keywordstopics/t-kt_evaluation_metrics.csv", index=False)
    ...
    df_report.to_csv("../../data/keywordstopics/t-kt_classification_report.csv", index=True)
    ...
    df_conf_matrix.to_csv("../../data/keywordstopics/t-kt_confusion_matrix.csv", index=True)
    ...
    if not df_misclassified.empty:
        df_misclassified.to_csv("../../data/keywordstopics/t-kt_misclassified_reviews.csv", index=False)
