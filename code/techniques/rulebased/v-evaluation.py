...
predictions_file = "../../data/rulebased/v-r_results.csv"  # Updated file path for emotion-based results
...
try:
    ...
    df_metrics.to_csv("../../data/rulebased/v-r_evaluation_metrics.csv", index=False)
    ...
    df_report.to_csv("../../data/rulebased/v-r_classification_report.csv", index=True)
    ...
    df_conf_matrix.to_csv("../../data/rulebased/v-r_confusion_matrix.csv", index=True)
    ...
    if not df_misclassified.empty:
        df_misclassified.to_csv("../../data/rulebased/v-r_misclassified_reviews.csv", index=False)
