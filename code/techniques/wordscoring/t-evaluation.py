...
predictions_file = "../../data/wordscoring/t-wd_results.csv"
...
try:
    ...
    df_metrics.to_csv("../../data/wordscoring/t-wd_evaluation_metrics.csv", index=False)
    ...
    df_report.to_csv("../../data/wordscoring/t-wd_classification_report.csv", index=True)
    ...
    df_conf_matrix.to_csv("../../data/wordscoring/t-wd_confusion_matrix.csv", index=True)
    ...
    if not df_misclassified.empty:
        df_misclassified.to_csv("../../data/wordscoring/t-wd_misclassified_reviews.csv", index=False)
